...
export class ExosphereClient {
    ...
    withTimeout(init, timeoutMs) {
        ...
        combined.__cleanupTimeout = cleanup;
    ...
    async upsertGraph(graph) {
        return this.requestJson("/v1/graphs/upsert", {
            method: "POST",
            body: JSON.stringify({ graph }),
        });
    }
    async upsertNodeModel(graphId, node) {
        return this.requestJson(`/v1/graphs/${encodeURIComponent(graphId)}/nodes/upsert`, {
            method: "POST",
            body: JSON.stringify({ node }),
        });
    }
    async trigger(request) {
        return this.requestJson("/v1/runs/trigger", {
            method: "POST",
